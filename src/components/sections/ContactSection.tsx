...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-32 px-6 border-t border-border bg-bg2">
      ...
      {/* Footer */}
      <div className="mx-auto max-w-6xl mt-24 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
        <span suppressHydrationWarning className="font-mono text-[0.68rem] text-text3 tracking-widest uppercase">
          Leonardo Diman · {new Date().getFullYear()}
        </span>
        <span className="font-mono text-[0.68rem] text-text3 tracking-wider">
